...
namespace Rosen_Limbu_CPRG200_Lab3.northwndDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Rosen_Limbu_CPRG200_Lab3.Properties.Settings.Default.northwndConnectionString;
        }
...
SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)";
        ...
        public virtual int GetIDBy(northwndDataSet.Order_DetailsDataTable dataTable, int ProductID) {
